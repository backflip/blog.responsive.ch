...
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| <Image src={aeotec} alt="Aeotec Nano Shutter"/>                                 | <Image src={fibaro} alt="Fibaro Roller Shutter 3"/>                                 | <Image src={qubino} alt="Qubino Flush Shutter"/>                   |
...
<Image src={raspberry} alt="Raspberry" />
