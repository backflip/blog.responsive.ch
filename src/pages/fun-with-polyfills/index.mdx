...
<img src={ride} alt="Dee and Dennis on a ride in episode 'The Gang Goes to the Jersey Shore' of 'It's Always Sunny in Philadelphia"/>
...
<img src={analysis} alt="Mac explaining things in 'Reynolds vs. Reynolds: The Cereal Defense' of 'It's Always Sunny in Philadelphia'"/>
...
<img src={success} alt="Glenn Howerton, Rob McElhenney and Charlie Day giving the thumbs up"/>
