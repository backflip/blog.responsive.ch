...
import ride from './media/ride.png';
...
<Image src={ride} alt="Dee and Dennis on a ride in episode 'The Gang Goes to the Jersey Shore' of 'It's Always Sunny in Philadelphia"/>
...
<Image src={analysis} alt="Mac explaining things in 'Reynolds vs. Reynolds: The Cereal Defense' of 'It's Always Sunny in Philadelphia'"/>
...
```js
window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=Array.prototype.forEach),document.querySelectorAll("a").forEach(function(o){console.log(o.href)});
```

<Image src={success} alt="Glenn Howerton, Rob McElhenney and Charlie Day giving the thumbs up"/>
...
<br />
<small>Photo credits: [FX Networks](https://www.fxnetworks.com/shows/its-always-sunny-in-philadelphia)</small>